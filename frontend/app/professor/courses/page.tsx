      ...
      <section className="max-w-5xl mx-auto mt-13 grid grid-cols-2 gap-4">
        ...
        <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-100">
          ...
          <div className="flex gap-2 mb-5">
            ...
            <button className="rounded-full px-4 py-2 text-sm text-[#1B1B1B] font-medium flex items-center gap-1.5 hover:text-[#5B41FF] transition-colors duration-200">
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-slate-100">
                <th className="text-left pl-15 pb-3 text-[#1B1B1B] font-medium text-x">
                  Name
                </th>
                <th className="text-right pr-10 pb-3 text-[#1B1B1B] font-medium text-x">
                  Total Questions
                </th>
              </tr>
            </thead>
            <tbody>
              {students.map(({ name, questions, online, avatar }) => (
                <tr
                  key={name}
                  className="border-b border-slate-50 last:border-0 hover:bg-slate-50 transition-colors duration-150 cursor-pointer"
                >
                  <td className="py-3">
                  ...
                  <td className="py-3 text-right pr-20">
                    <span
                      className={`font-semibold text-base ${questions > 0 ? "text-[#5B41FF]" : "text-slate-300"}`}
                    >
                      {questions}
                    </span>
                  </td>
