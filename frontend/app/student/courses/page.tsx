...
export default function StudentClass() {
  ...
  return (
    <div className="flex-1 p-8 bg-[#FCF9F8] min-h-screen font-sans text-slate-700">
      ...
      {/* SESSION CARD */}
      <section className="bg-white rounded-[30px] p-5 shadow-lg border border-slate-50 mb-8 overflow-hidden relative text-left mt-12 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-2 gap-6 mb-7">
          ...
          <div className="flex items-center gap-4 bg-[#F9F9F9] p-6 rounded-full">
            ...
            <div>
              ...
              <p className="text-xl text-slate-800">{data.session.instructor}</p>
            </div>
          </div>
        </div>
      ...
      <section className="max-w-5xl mx-auto mt-10">
        <h3 className="text-2xl font-regular mb-4">ActivityTimeline</h3>

        <div className="flex flex-wrap items-center gap-3 mb-8">
          
          {/* Filter buttons — แบบ border */}
...
function StudentActivityCard({ data }: any) {
  ...
  return (
    <div className="bg-white rounded-2xl p-5 shadow-sm border border-slate-50 relative">
      ...
      <div className={`absolute top-5 right-5 flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-regular ${
            ...
            <div>
              ...
              {data.professorReply && (
                <div className="border border-emerald-100 rounded-xl p-3 bg-[#F0FDF4] mb-2">
                  <span className="text-[1xl] font-regular text-emerald-600">Professor Reply</span>
                  <p className="text-sm text-slate-700">{data.professorReply}</p>
                </div>
              )}
